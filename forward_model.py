...
mne.viz.plot_alignment(Data.info, trans, subject=subject, dig=True,
...
src_dense = mne.setup_source_space(subject, spacing='ico5',
                             subjects_dir=subjects_dir, add_dist=False)
...
mne.viz.plot_alignment(Data.info, subject=subject, subjects_dir=subjects_dir,
                       meg='helmet', bem=bem, dig=True,
                       surfaces=['brain'])

# forward operator
fwd_dense = mne.make_forward_solution(fname, trans=trans, src=src_dense, bem=bem,
                                meg=True, eeg=False, mindist=5.0, n_jobs=2)

fwd = mne.make_forward_solution(fname, trans=trans, src=src, bem=bem,
                                meg=True, eeg=False, mindist=5.0, n_jobs=2)
