...
num_sim = 10
snr = [1, 2]
spatial_jitter = [0, 0.001]

[auc, direction_error, direction_error_smooth, direction_error_pca, speed_generated, speed_estimated] = \
    direction_error_bst(data_dir, channel_type, params, snr, spatial_jitter, num_sim=2)